...
export default class Notifications extends Listenable {
	...
	create(opts, callback) {
		...
		return new Promise((resolve) => {
			chrome.notifications.create(notifId, newOpts, (callback) =>
				resolve(callback),
			);
		});
	}
	...
	update(...args) {
		return new Promise((resolve) => {
			chrome.notifications.update(...args, (callback) =>
				resolve(callback),
			);
		});
	}
	...
	clear(...args) {
		return new Promise((resolve) => {
			chrome.notifications.clear(...args, (callback) =>
				resolve(callback),
			);
		});
	}
